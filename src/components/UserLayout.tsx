...
const UserLayout = (props: PropsWithChildren) => {
    ...
    return (
        <div className="flex h-full bg-orange-500 font-sans" >
            <aside className="z-20 h-full flex-shrink-0 hidden w-60 pl-2 overflow-y-auto bg-orange-500 lg:block flex-col justify-evenly">
                <div className="h-full justify-evenly">
                    <div className="h-full text-white justify-evenly">
                        <div className="flex p-2 bg-orange-500">
                            <div className="flex flex-col py-3 px-2 items-center">
                                <p className="text-2xl text-white font-bold">BeyondPhysique</p>
                            </div>
                        </div>
                        ...
                        <div className="h-screen justify-between">
                            <ul className="mt-6 leading-10">
                                ...
                                {/* x-on:click="Open = !Open" */}
                                {/* <a
                                        className="inline-flex items-center  text-sm font-semibold text-white hover:text-yellow-400" href="/grocery">
                                        ...
                                        <span className="ml-4">Grocery</span>
                                    </a>
                                    <svg xmlns="http://www.w3.org/2000/svg" 
                                        className="ml-1  text-white w-4 h-4 hidden" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor" > */}
                            ...
                            <ul>
                                ...
                                <li className="relative px-2 py-1" >
                                    ...
                                    >
                                        {/* x-on:click="Open = !Open" */}
                                        <a
                                            className="inline-flex items-center  text-sm font-semibold text-white hover:text-yellow-400" href="/settings">
