...
const UserSidebar = ({ open, setOpen }: Props) => {
  ...
  return (
      ...
      <aside className={classNames({
        ...
        "bg-[#EC7E4A] text-zinc-50": true, // colors
              ...
              <ul className="mb-6 flex flex-col gap-1.5">
                ...
                <li>
                  <Link
                    ...
                    <svg className="fill-current" width="18" height="18" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
