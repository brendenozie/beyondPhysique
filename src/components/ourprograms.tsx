      ...
      <div className="flex flex-col sm:flex-row gap-6 flex-wrap">
        {programsData.map((program) => (
          <motion.div
            ...
            className="flex flex-col bg-gray-700 p-6 sm:p-8 gap-4 text-white rounded-lg shadow-md flex-1 cursor-pointer transition-all"
            key={program.heading}
          >
            {/* Program Image */}
            <div className="w-12 h-12">{program.image}</div>
