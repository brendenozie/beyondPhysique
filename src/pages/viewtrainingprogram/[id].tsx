...
import { IDailyPlan, IExercise, IExerciseCategory, ITrainingProgram } from "@/types/typings";
                                                ...
                                                <div className="flex flex-col md:flex-row gap-1 w-full md:min-w-fit justify-center items-center md:justify-end">
                                                    {/* <Link href="/foodplan" className="w-full  md:w-1/3">
														<button className="w-full focus:ring-2 focus:ring-offset-2 text-center focus:ring-indigo-600 mt-4 sm:mt-0 inline-flex  justify-center px-6 py-3 bg-indigo-700 hover:bg-indigo-600 focus:outline-none rounded">
															<p className="text-sm font-medium leading-none text-white">Our Online Classes</p>
														</button>
													</Link>
													<Link href="/foodplan" className="w-full md:w-1/3">
                                        ...
                                        <div className="relative grid gap-5 sm:grid-cols-1 lg:grid-cols-5 mt-4 text-black">
                                            {props.trainingProgramData &&
                                                props.trainingProgramData.results.map((item: ITrainingProgram, index: number) => (
                                                    (index === 0) ? (
                                                        <div className="p-4 bg-white rounded-lg col-span-2 shadow-md w-full ">
                                                            <Image
                                                                src={img}
                                                                alt="calories"
                                                                fill={false}
                                                        ...
                                                        <div key={index} className="p-4 bg-white rounded-lg shadow-md w-full">
                                                            ...
                                                            />
                                                            <div className="text-lg font-semibold">{item.trainingName}</div>
