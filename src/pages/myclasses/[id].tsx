										...
										exercise.exercises?.map((item: IExercise) => (
											<div className="relative w-full">
												...
												<div className="ml-6">
													...
													<a href={`/viewworkout/${item.id}`} className="mt-1 block text-sm font-semibold text-blue-500">Begin</a>
												</div>
											</div>
										))}
...
export const getServerSideProps = async (
	...
	let exerciseUrl = `${process.env.NEXT_PUBLIC_API_URL}/get-my-training-programs/${id}`;
