                ...
                <div className="container mx-auto">
                      ...
                      <div className="mt-4 gap-4 grid grid-cols-2 md:grid-cols-3">
                        ...
                        <Link href={"/calculatebpm"}>
                          <div className="transform transition-transform hover:scale-105 flex flex-col justify-between items-center py-4 bg-gradient-to-r from-blue-100 to-blue-200 p-6 rounded-lg shadow-lg relative">
                              <Image src={edit} alt="edit" loader={loaderProp} className="w-4 h-4 absolute top-2 right-2" />
                            <Image src={heart} alt="heart" loader={loaderProp} width={64} height={64} className="mt-4 w-48 h-32 mx-auto" />
                        ...
                        <Link href={"/calculatebmi"}>
                          <div className="transform transition-transform hover:scale-105 flex flex-col justify-between items-center py-4 bg-gradient-to-r from-pink-100 to-pink-200 p-6 rounded-lg shadow-lg relative">
                              <Image src={edit} alt="edit" loader={loaderProp} className="w-4 h-4 absolute top-2 right-2" />
                            <Image src={bmi} alt="bmi" loader={loaderProp} width={64} height={64} className="mt-4 w-40 h-32 mx-auto" />
                        ...
                        <Link href={"/calculatesleep"}>
                          <div className="transform transition-transform hover:scale-105 flex flex-col justify-between items-center py-4 bg-gradient-to-r from-purple-100 to-purple-200 p-6 rounded-lg shadow-lg relative">
                            <Image src={edit} loader={loaderProp} alt="edit" className="w-4 h-4 absolute top-2 right-2" />
                    ...
                    <div className="mt-6">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="py-1 font-semibold text-black text-lg">Today's Plan</h3>
                        <a className="py-2 px-6 bg-purple-600 font-semibold text-white rounded-lg shadow-lg hover:bg-purple-700 transition-colors" href="/exerciseschedule">View All</a>
                      </div>
                        ...
                        <div className="mt-6">
                          {props.programsCategoryData && props.programsCategoryData.results?.map((item: IProgramsCategory, index: number) => (
                            <Link href={`/onlineclassesbycat/${item.id}`}>
                              <div className={`${index % 2 === 0 ? "bg-white" : "bg-orange-500 "} p-6 transform transition-transform hover:scale-105 `}>
                                  <h2 className="text-2xl font-bold mb-4">{item.pcName}</h2>
                                  <p className="font-mono text-base">{item.pcDesc}</p>
                                  <div className="mt-4">
                                      <h2 className={`mt-4 ${index % 2 === 0 ? "bg-orange-500 hover:bg-orange-600" : "bg-gray-900 hover:bg-gray-800"}  text-white items-center justify-center text-center py-2 px-4 rounded`}>View</h2>
                                  </div>
                              </div>
                            </Link>
                          ))}
