...
const clients = [
    {
      ...
      nextMeal: 'Breakfast: Udon with Chicken and Garlic Peanut Dressing',
      progress: 80,
      checkIn: '10 Feb, 2022 10:00AM'
    },
    {
      name: 'Annette Black',
      plan: 'Health Plan',
      nextMeal: 'Lunch: Fried eggs & Mashed Potatoes',
      progress: 31,
      checkIn: '10 May, 2022 10:00AM'
    },
    {
      name: 'Kathryn Murphy',
      plan: 'Health Plan',
      nextMeal: 'Lunch: Chick Peas Salad with Vegetable Sauce',
      progress: 71,
      checkIn: '17 Jun, 2022 10:00AM'
    },
    {
      name: 'Kristin Watson',
      plan: 'Weight gain diet',
      nextMeal: 'Dinner: Mashed potatoes Hash',
      progress: 62,
      checkIn: '10 Sep, 2022 10:00AM'
    },
    {
      name: 'Theresa Webb',
      plan: 'Weight loss diet',
      nextMeal: 'Breakfast: Boiled Eggs with Vegetable Sauce',
      progress: 9,
      checkIn: 'No check-ins yet'
    },
    {
      name: 'Guy Hawkins',
      plan: 'Health Plan',
      ...
      <UserNav/>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {clients.map((client, index) => (
                <div className="bg-white shadow-md rounded-lg p-4 mb-4 gap-6">
                    <div className="flex items-center mb-2">
                        <div className="w-10 h-10 rounded-full bg-gray-200 mr-3"></div>
                        <div>
                            <h2 className="text-lg font-semibold text-black">{client.name}</h2>
                            <p className="text-sm text-gray-600">{client.plan}</p>
                        </div>
                    </div>
                    <div className="mb-2">
                        <p className="text-sm font-medium text-black">Next Meal:</p>
                        <p className=" text-black">{client.nextMeal}</p>
                    </div>
                    <div className="flex justify-between items-center">
                        <div className="text-sm text-gray-600 ">
                            Progress: <span className="font-semibold text-black">{client.progress}%</span>
                        </div>
                        <div className="text-sm text-gray-600">
                            Upcoming Check-In: <span className="font-semibold">{client.checkIn}</span>
                        </div>
                    </div>
                </div>
            ))}
